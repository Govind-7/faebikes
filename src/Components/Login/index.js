...
const Login = () => {
  ...
  const verifyOtp = async (event) => {
    ...
    const ccbpurl = "https://apis.ccbp.in/login";
    const ccbpoptions = {
      method: "POST",
    ...
    if (response.ok) {
      const res = await fetch(ccbpurl, ccbpoptions);
